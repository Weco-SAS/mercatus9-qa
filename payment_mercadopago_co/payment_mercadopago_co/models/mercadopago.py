...
from odoo.addons.payment_mercadopago_co.controllers.main import MercadoPagoController
...
from odoo.addons.payment_mercadopago_co.mercadopago import mercadopago
...
#	            },
    ...
    def mercadopago_co_get_form_action_url(self):
        ...
        return self._get_mercadopago_co_urls(environment)['mercadopago_form_url']
    ...
    def _mercadopago_co_s2s_get_access_token(self, ids, context=None):
        ...
        for acquirer in self.browse( ids, context=context):
            ...
            tx_url = self._get_mercadopago_co_urls( environment)['mercadopago_rest_url']
